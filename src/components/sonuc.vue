            ...
            <div class="wrapper">
              <div class="left">
                <p v-if="posts">
                  ...
                  {{ posts.city }}’da yaşayan bir {{ posts.job }} mesleğini
                  yerine getiren biri olarak. Daha zengin, mutlu ve üretken bir
                ...
                <p>
                  <strong
                    >İktidara geldiğimiz ilk gün hayata geçirmek üzere
